...
st.set_page_config(page_title="Developers", page_icon="D:\PBL-3\FE.png", layout="wide")
...
display_member("<h2>Madhav Kalra</h2>", "Student", "D:\PBL-3\mk.jpg", your_about_text, your_social_links)  # Update the image path
